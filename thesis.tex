...
proc adaptive practice: flow \cite{flow}, the sweet spot of learning", (not too easy, not too hard), balance between boredom (apathy) and frustration \cite{adaptive-practice}
...
... kdyz mam dopredu otazky/fakta, muzu se podrobneji zamerit na odhad obtiznosti faktu/otazek a ne prubeznem vylepsovani jeho znalosti (spaced reptition) danym studentem. My jsme v odlisne situaci, vygenerovali jsme NOVE otazky, nic o nich nevime, o studentovi nejspis taky nic nevime: co muzeme delat: snazit se odhadnout global skill studenta co nejpresneji behem co nejmene otazek a davat mu pak takove, na ktere bude mit idealni pravdedpodbnost spravne odpovedi, tj. aby ho to udrzelo ve flow
