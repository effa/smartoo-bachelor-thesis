...
\end{equation}
MaybeTODO: ze neuvazuje uceni, pro nas ok
TODO: parameters estimation, obvykle joint maximum likelihood estimation, napr: R. De Ayala. The theory and practice of item response theory. The Guilford Press, 2008,
ale nase situace je jina: mamem odhady obtiznosti otazek a vzhledem k temto odhadum chceme nafitovat odhad znalosti k.
...
The main advantage of using the Elo model to estimate the prior knowledge and difficulties in comparision with the joint maximum likelihoood estimation technique (odkaz vyse) is its simplicity and intrinsic online nature.
