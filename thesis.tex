...
For example some systems try to test reading comprehension \cite{question-overgenerating-rating},
some focus on foreign language learning [TODO: citovat],
some on factual texts \cite{question-gen-heilman}
...
Some of the features used in his classifier were:
  ...
  \item \textbf{Text rephrasing}\\
    ...
    The goal...
    TODO: napr. anaphora resolution, par ukazek, moznost citovat ty postery z Procvicniku-v-1
    What might help:
    \begin{itemize}
...
As distractors, subjects of objects of the same class as the removed one are used.
...
[Maybe TODO: neco citovat - mozna ty ontologie, mozna Heilman (phd)]
...
Filtering can be implemented via heurstics decisions
...
TODO: Prozkoumat clanek Question Generation via Overgenerating Transformations and Ranking (phd teze), pro mozne zduvodneni komponenty ExercisesGrader, hodnoceni (pro vyber 6 nejlepsich otazek na odstavec) je take v
\cite{question-gen-mannem} a rozhodne: \cite{question-overgenerating-rating}
