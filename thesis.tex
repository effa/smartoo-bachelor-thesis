...
\usepackage{lmodern} % setting input encoding \usepackage[utf8]{inputenc}
...
TODO: k nasledujicimu obrazku povidani o architekture, itemize jednotlivych baliku (vc. common, abstract-component), zduraznit modularitu
...
Postup parsovani textu:

\begin{myItemize}
  \item text preprocessing: discarded uniteresting sections such as "See also" or "External links"
  \item split text into sentences
  \item tokenize each sentence to words (tokens)
  \item assign part-of-speach (POS) tag to each word (TODO: poznamka o pouzitem TagSetu, odkaz/citace)
\end{myItemize}

TODO: odkaz na knihovnu nltk a citace knizky o NLP v Pythonu (podobne jinde odkaz na knihovnu pro Wikipedii?)

TODO: o pouzitym TAGsetu, par prikladu (CD, NNP, NN, DT)

TODO: taky ze se zjisti pojmy a i kazdy pojem se shallow-parsne
...
{'terms': [
    ...
    ['John Wilkes Booth', ['John', 'NNP'], ['Wilkes', 'NNP'], ['Booth', 'NNP']]],
    ...],
...
TODO: For the purpose of knowledge building, t

TODO: terms inference

Ukazka stromu pro 1 vetu:
