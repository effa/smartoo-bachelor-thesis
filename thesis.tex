...
The source code of the project is available from its repository%
\footnote{\url{http://github.com/effa/smartoo}}.
Smartoo has been deployed on \url{http://smartoo.thran.cz}.
In this chapter, I describe a few deployment details
